...
export const common = {
  ...
  titles: {
    ...
    profile: 'Profile',
    profileByName: (name: string) => `${name} - Profile`,
  ...
  auth: {
    ...
    name: 'Display Name',
    nameHelp: (min: number, max: number) => `Only English letters, digits, dashes and underscores. Must be between ${min} and ${max} characters. Can be changed later.`,
    ...
    password: 'Password',
    passwordHelp: (min: number) => `Must be at least ${min} characters long and not commonly used.`,
    rememberMe: 'Keep me signed in',
    signInButton: 'Sign In',
    registerButton: 'Create Account',
    invalidCredentials: 'Incorrect e-mail address or password',
    rateLimited: (count: number) => `Too many signin attempts, please try again in ${count} ${plural(count, 'second', 'seconds')}`,
